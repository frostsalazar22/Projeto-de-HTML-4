...
class InformacoesPage extends StatelessWidget {
  ...
  final List<Map<String, String>> funcionalidades = const [
    ...
    },
    {
      ...
      "descricao": "Controle sua conta, preferências e fichas com autonomia.",
    },
  ];
      ...
      children: [
        Image.asset(
          ...
          errorBuilder: (context, error, stack) =>
              Container(height: 300, color: AppColors.header),
        ),
        Container(
          height: 300,
          ...
          Expanded(
            ...
            child: ClipRRect(
              ...
              child: Image.asset(
                ...
                fit: BoxFit.cover,
                errorBuilder: (c, e, s) =>
                    Container(height: 200, color: AppColors.cardDark),
              ),
            ),
          ),
      ...
      Expanded(
        ...
        child: ClipRRect(
          ...
          child: Image.asset(
            ...
            fit: BoxFit.cover,
            errorBuilder: (c, e, s) =>
                Container(height: 180, color: AppColors.cardDark),
          ),
        ),
      ),
    ];
